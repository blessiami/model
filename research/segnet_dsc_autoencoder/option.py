...
class Option(object):
    def __init__(self):
        ...
        # basic options
        self._parser.add_argument('--num_workers', type=int, default=2, help='The number of workers')
        ...
        # self._parser.add_argument('--resume', type=str, default='./weight/espnetv2_segmentation_s_1.5.pth',
        ...
        self._parser.add_argument('--train_size', nargs='+', type=int, default=[480, 360],
                                  help='Training image size [width, height]')
        self._parser.add_argument('--train_data', type=str, default='/home/ljy/work/item/work/data/camvid',
        ...
        self._parser.add_argument('--learning_rate', type=float, default=1e-2, help='Parameter update rates')
        ...
        self._parser.add_argument('--val_size', nargs='+', type=int, default=[480, 360],
                                  help='Validation image size [width, height]')
        self._parser.add_argument('--val_data', type=str, default='/home/ljy/work/item/work/data/camvid',
